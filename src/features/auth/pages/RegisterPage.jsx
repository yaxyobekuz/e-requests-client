...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 relative overflow-hidden">
      {/* Left side: branding/illustration (formerly right side) */}
      <div className="hidden lg:flex w-1/2 flex-col justify-between overflow-hidden relative bg-slate-900 border-r border-slate-800">
        ...
        <div className="relative z-10 px-12">
          <h1 className="text-4xl xl:text-5xl font-extrabold text-white leading-tight mb-6 tracking-tight">
            Muammolaringizga <br />
            <span className="text-blue-400">yechim toping.</span>
          </h1>
          <p className="text-lg text-slate-300 max-w-md">
            Ro'yxatdan o'ting va davlat organlariga o'z murojaatlaringizni to'g'ridan-to'g'ri yuboring. Oson va tez.
          </p>
          ...
          <div className="mt-12 flex gap-4 w-full">
            <div className="p-5 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10 flex-1 hover:bg-white/15 transition-colors">
              <h3 className="font-bold text-white text-xl mb-1">Qulay</h3>
              <p className="text-sm text-slate-400">Tezkor ro'yxatdan o'tish</p>
            </div>
            <div className="p-5 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10 flex-1 hover:bg-white/15 transition-colors">
              <h3 className="font-bold text-white text-xl mb-1">Xavfsiz</h3>
              <p className="text-sm text-slate-400">Maxfiylik kafolatlangan</p>
            </div>
          </div>
        </div>

        <div className="relative z-10 px-12 pb-12 text-slate-500 text-sm">
          &copy; {new Date().getFullYear()} e-Murojaat. Barcha huquqlar himoyalangan.
        </div>
      </div>

      {/* Right side: Register form (formerly left side) */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative z-10">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:shadow-none sm:bg-transparent border border-slate-100 sm:border-none p-8 sm:p-0">
          <div className="text-center sm:text-left mb-10">
            ...
            <p className="text-slate-500">Yangi hisob yarating</p>
          </div>
